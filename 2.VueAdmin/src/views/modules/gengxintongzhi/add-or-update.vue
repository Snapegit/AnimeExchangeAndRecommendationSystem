<template>
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="通知名称" prop="tongzhimingcheng">
					<el-input  v-model="ruleForm.tongzhimingcheng" placeholder="通知名称" clearable  :readonly="ro.tongzhimingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="通知名称" prop="tongzhimingcheng">
					<el-input v-model="ruleForm.tongzhimingcheng" placeholder="通知名称" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="通知内容" prop="tongzhineirong">
					<el-input  v-model="ruleForm.tongzhineirong" placeholder="通知内容" clearable  :readonly="ro.tongzhineirong"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="通知内容" prop="tongzhineirong">
					<el-input v-model="ruleForm.tongzhineirong" placeholder="通知内容" readonly></el-input>
				</el-form-item>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `gengxintongzhi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.gengxintongzhiCrossAddOrUpdateFlag = false;
						 this.parent.search();
