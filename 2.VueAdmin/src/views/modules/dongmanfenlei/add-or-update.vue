<template>
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="动漫分类" prop="dongmanfenlei">
					<el-input  v-model="ruleForm.dongmanfenlei" placeholder="动漫分类" clearable  :readonly="ro.dongmanfenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="动漫分类" prop="dongmanfenlei">
					<el-input v-model="ruleForm.dongmanfenlei" placeholder="动漫分类" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.image" label="image" prop="image">
					<file-upload
						tip="点击上传image"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.image" label="image" prop="image">
