...
<div :style='{"width":"100%","padding":"30px 10% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="动漫分类" prop="dongmanfenlei">
            <el-select v-model="ruleForm.dongmanfenlei" placeholder="请选择动漫分类"  >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="动漫作者" prop="dongmanzuozhe">
            <el-input  v-model="ruleForm.dongmanzuozhe" 
                placeholder="动漫作者" clearable :readonly=" false  ||ro.dongmanzuozhe"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="动漫视频" v-if="type!='cross' || (type=='cross' && !ro.dongmanshipin)" prop="dongmanshipin">
            <file-upload
            tip="点击上传动漫视频"
            action="file/upload"
            :limit="1"
		  ...
		  <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' class="upload" v-else label="动漫视频" prop="dongmanshipin">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="动漫介绍" prop="dongmanjieshao">
            <editor 
