	...
	<div class="main-containers">
		...
		<div class="top-container" :style='{"boxShadow":"0 0px 0px rgba(64, 158, 255, .3)","padding":"0 10%","borderColor":"#eee","margin":"0 0 90px","alignItems":"center","color":"#666","textAlign":"right","display":"block","top":"0","left":"0","background":"#e9e9e9","borderWidth":"0px","width":"100%","fontSize":"14px","position":"relative","borderStyle":"solid","height":"30px","zIndex":"1002"}'>
			...
			<div :style='{"margin":"0px 0 0","position":"absolute","top":"60px","float":"left","display":"block"}'>
			  <span :style='{"padding":"0 0 0 12px","lineHeight":"30px","fontSize":"36px","color":"#666","float":"left","fontWeight":"600"}'>动漫交流与推荐平台</span>
			</div>
...
export default {
    data() {
		return {
            activeIndex: '0',
			roleMenus: [{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","首页总数"],"appFrontIcon":"cuIcon-time","buttons":["新增","查看","修改","删除","首页总数"],"menu":"用户","menuJump":"列表","tableName":"yonghu"}],"menu":"用户管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-similar","buttons":["新增","查看","修改","删除"],"menu":"动漫分类","menuJump":"列表","tableName":"dongmanfenlei"}],"menu":"动漫分类管理"},{"child":[{"allButtons":["新增","查看","修改","删除","动漫分类统计","查看评论","首页总数","首页统计","在线订阅"],"appFrontIcon":"cuIcon-time","buttons":["新增","查看","修改","删除","查看评论","首页总数","首页统计"],"menu":"动漫信息","menuJump":"列表","tableName":"dongmanxinxi"}],"menu":"动漫信息管理"},{"child":[{"allButtons":["新增","查看","修改","删除","审核","动漫订阅统计","首页总数","首页统计","更新通知"],"appFrontIcon":"cuIcon-medal","buttons":["查看","修改","删除","审核","更新通知","首页总数","首页统计"],"menu":"订阅信息","menuJump":"列表","tableName":"dingyuexinxi"}],"menu":"订阅信息管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-keyboard","buttons":["查看","修改","删除"],"menu":"更新通知","menuJump":"列表","tableName":"gengxintongzhi"}],"menu":"更新通知管理"},{"child":[{"allButtons":["查看","修改","回复","删除"],"appFrontIcon":"cuIcon-message","buttons":["查看","修改","回复","删除"],"menu":"在线留言","tableName":"messages"}],"menu":"在线留言"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-group","buttons":["查看","修改","删除"],"menu":"社区互动","tableName":"forum"}],"menu":"社区互动"},{"child":[{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-send","buttons":["查看","修改"],"menu":"关于我们","tableName":"aboutus"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-present","buttons":["查看","修改"],"menu":"轮播图管理","tableName":"config"},{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-full","buttons":["查看","修改"],"menu":"系统简介","tableName":"systemintro"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"公告信息","tableName":"news"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"公告信息分类","tableName":"newstype"}],"menu":"系统管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","动漫分类统计","查看评论","首页总数","首页统计","在线订阅"],"appFrontIcon":"cuIcon-rank","buttons":["查看","在线订阅"],"menu":"动漫信息列表","menuJump":"列表","tableName":"dongmanxinxi"}],"menu":"动漫信息模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"管理员","tableName":"users"},{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","审核","动漫订阅统计","首页总数","首页统计","更新通知"],"appFrontIcon":"cuIcon-medal","buttons":["查看"],"menu":"订阅信息","menuJump":"列表","tableName":"dingyuexinxi"}],"menu":"订阅信息管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-keyboard","buttons":["查看"],"menu":"更新通知","menuJump":"列表","tableName":"gengxintongzhi"}],"menu":"更新通知管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","动漫分类统计","查看评论","首页总数","首页统计","在线订阅"],"appFrontIcon":"cuIcon-rank","buttons":["查看","在线订阅"],"menu":"动漫信息列表","menuJump":"列表","tableName":"dongmanxinxi"}],"menu":"动漫信息模块"}],"hasBackLogin":"否","hasBackRegister":"否","hasFrontLogin":"是","hasFrontRegister":"是","roleName":"用户","tableName":"yonghu"}],
			baseUrl: '',
			carouselList: [],
			menuList: [],
			form: {
			...
			bottomContent: '<strong>宇宙动漫网站的设计与实现</strong>',
		}
    },
    created() {
