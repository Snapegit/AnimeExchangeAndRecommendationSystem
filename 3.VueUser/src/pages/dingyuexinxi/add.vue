...
<div :style='{"width":"100%","padding":"30px 10% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="120px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="订阅单号" prop="dingyuedanhao">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="动漫名称" prop="dongmanmingcheng">
            <el-input  v-model="ruleForm.dongmanmingcheng" 
                placeholder="动漫名称" clearable :readonly=" false  ||ro.dongmanmingcheng"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="订阅日期" prop="dingyueriqi">
              <el-date-picker
				  :disabled="true  ||ro.dingyueriqi"
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="信息备注" prop="xinxibeizhu">
            <el-input  v-model="ruleForm.xinxibeizhu" 
                placeholder="信息备注" clearable :readonly=" false  ||ro.xinxibeizhu"></el-input>
          </el-form-item>
